...
namespace AddRoutesOnMap.CustomControls
{
    public class CustomMap : Map
    {
        ...
        /// <summary>
        /// Bindable Property of <see cref="ItemSource"/>
        /// </summary>
        public static BindableProperty ItemSourceProperty = BindableProperty.Create(
         propertyName: "ItemSource",
         returnType: typeof(IEnumerable<CustomPin>),
         declaringType: typeof(CustomMap),
         defaultValue: null, defaultBindingMode: BindingMode.Default, propertyChanged: OnItemsSourceChanged);

        public IEnumerable<CustomPin> ItemSource
        {
            get { return (IEnumerable<CustomPin>)this.GetValue(ItemSourceProperty); }
        ...
        /// Bindable Property of <see cref="ItemSource"/>
        /// </summary>
        public static BindableProperty AdditionalServicesProperty = BindableProperty.Create(
         propertyName: "ItemSource",
         returnType: typeof(IEnumerable<CustomPin>),
         declaringType: typeof(CustomMap),
         defaultValue: null, defaultBindingMode: BindingMode.Default, propertyChanged: OnAdditionalServicesChanged);

        public IEnumerable<CustomPin> AdditionalServices
        {
            get { return (IEnumerable<CustomPin>)this.GetValue(AdditionalServicesProperty); }
            set { this.SetValue(AdditionalServicesProperty, value); }
        }

        ///<summary>
        ///Bindable Property of <see cref="MapViewName">
        ///</summary>
        public static BindableProperty MapViewNameProperty = BindableProperty.CreateAttached(
            propertyName: "MapViewName"
            ,
            returnType: typeof(string)
            ,
            declaringType: typeof(CustomMap)
            ,
            defaultValue: "MapViewName"
            );
        public string MapViewName
        {
            get { return this.GetValue(MapViewNameProperty).ToString(); }
            set { this.SetValue(MapViewNameProperty, value); }
        }
        ...
        public static readonly BindableProperty MapRegionProperty = BindableProperty.Create(
            ...
            typeof(MapSpan),
            typeof(CustomMap),
            defaultBindingMode: BindingMode.TwoWay, propertyChanged: MoveToMapRegion);

        private static void MoveToMapRegion(BindableObject bindable, object oldValue, object newValue)
        {
            try
            {
                var behavior = bindable as Map;
                var mapSpan = (MapSpan)newValue;
                behavior.MoveToRegion(mapSpan);
            }
            catch (Exception ex)
            {
        ...
        {
            var behavior = bindable as CustomMap;

            if (behavior.CustomPins == null)
            {
                behavior.CustomPins = new List<CustomPin>();
            }

            var newItems = (List<CustomPin>)newValue;
            try
            {
                if (newItems != null)
                {
        ...
        private static void OnAdditionalServicesChanged(BindableObject bindable, object oldValue, object newValue)
        {
            var behavior = bindable as CustomMap;
